...
//                        System.out.println("BEGIN AGAIN:     "+token.getValue());
                            if (environment.isDefined(varname)) { // check if variable exist [x is declared]
...
//                                            System.out.println("OPERATORRRRRRR");
                                                ...
                                                String expression = token.getValue();
                                                ExpressionParser2 expressionParser = new ExpressionParser2(environment);
                                                int result = (int) expressionParser.evaluateExpression(expression);
//                                                if (result instanceof Integer) {
//                                                    new_value = (int) result;
//                                                } else if (result instanceof Double) {
//                                                    new_value = (double) result;
//                                                }
                                                new_value = result;
